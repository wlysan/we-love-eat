<?php $title = 'Visualizar Plano de Dieta - ' . APP_NAME; ?>
...
<div class="container my-5">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2><?= $plan['name'] ?></h2>
            <p class="text-muted">
                Plano para <strong><?= $plan['client_name'] ?></strong>
                de <?= Formatter::formatDate($plan['start_date']) ?> a <?= Formatter::formatDate($plan['end_date']) ?>
                <span class="badge <?= $plan['status'] === 'active' ? 'bg-success' : ($plan['status'] === 'completed' ? 'bg-secondary' : 'bg-danger') ?> ms-2">
                    <?= $plan['status'] === 'active' ? 'Ativo' : ($plan['status'] === 'completed' ? 'Concluído' : 'Cancelado') ?>
                </span>
            </p>
        </div>
        <div class="col-md-4 text-md-end">
            <a href="/nutritionist/diets" class="btn btn-outline-secondary me-2">
                <i class="fas fa-arrow-left me-1"></i> Voltar
            </a>
            <a href="/nutritionist/diets/edit?id=<?= $plan['id'] ?>" class="btn btn-primary">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-8 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-header bg-white">
                    <h5 class="card-title mb-0">Aderência do Cliente</h5>
                </div>
                <div class="card-body">
                    <div class="row">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-footer bg-white">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/chats/create?client_id=<?= $plan['user_id'] ?>" class="btn btn-outline-primary">
                                <i class="fas fa-comments me-1"></i> Conversar com Cliente
                            </a>
                        </div>
                    </div>
                </div>
