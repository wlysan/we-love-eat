...
class DashboardController
{
    ...
    public function __construct()
    {
        ...
        $this->orderModel = new Order(); // Add this line
    ...
    public function user()
    {
        ...
        // Add this code to the user() method to get popular meals
        // Get popular meals
        $popularMeals = $this->mealModel->getPopularMeals(5);
        ...
        view('dashboard/user', [
            ...
            'popularMeals' => $popularMeals // Add this line
        ]);
    }
    ...
    public function restaurant()
    {
        ...
        $recentOrders = [];
        if ($restaurant) {
            $recentOrders = $this->orderModel->getByRestaurantId($restaurant['id'], 5);
        }
        ...
        view('dashboard/restaurant', [
            ...
            'recentOrders' => $recentOrders // Add this line
        ]);
    }
}
